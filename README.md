...
Core Launcher is a Windows Minecraft Java launcher focused on stability, clear instance management, modpack support, and a cleaner day-to-day launcher experience.
...
Core Launcher is being built to provide a launcher that feels more controlled and maintainable than the usual overloaded alternatives.
...
Core Launcher is structured around a few main areas:
...
Core Launcher is an independent project.
...
If additional public project links are added later, this README should remain the primary public overview of Core Launcher.